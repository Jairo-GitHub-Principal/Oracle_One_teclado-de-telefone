...
const inputTel = document.querySelector('input[type=tel]'); // seleciona a entrada de dados, onde o numero da tecla vai aparedcer quando o mesmo for clicado
...
for (let indice = 0; indice < listaDeTeclas.length; indice++) { // laço de repetição
  ...
  tecla.addEventListener("click",function () { /**aqui o addeventlistner implementa um evento de click para a tecla selecionado,
